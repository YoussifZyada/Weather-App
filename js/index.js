    ...
    switch ( Date(weather.forecast.forecastday[0].astro.date).toString().slice(0, 3) ) {
    case "Sat":
    ...
    switch (Date(weather.forecast.forecastday[0].astro.date).toString().slice(4, 7) ) {
    case "Jan":
        mounth.innerHTML = Date(weather.forecast.forecastday[0].astro.date).toString().slice(8, 10) +" January";
        break;
    case "Feb":
        mounth.innerHTML = Date(weather.forecast.forecastday[0].astro.date).toString().slice(8, 10) +" February";
        break;
    case "Mar":
        mounth.innerHTML = Date(weather.forecast.forecastday[0].astro.date).toString().slice(8, 10) +" March";
        break;
    case "Apr":
        mounth.innerHTML =Date(weather.forecast.forecastday[0].astro.date).toString().slice(8, 10) + " April";
        break;
    case "May":
        mounth.innerHTML = Date(weather.forecast.forecastday[0].astro.date).toString().slice(8, 10) +" May";
        break;
    case "Jun":
        mounth.innerHTML =Date(weather.forecast.forecastday[0].astro.date).toString().slice(8, 10) + " June";
        break;
    case "Jul":
        mounth.innerHTML =Date(weather.forecast.forecastday[0].astro.date).toString().slice(8, 10) + " July";
        break;
    case "Aug":
        mounth.innerHTML =Date(weather.forecast.forecastday[0].astro.date).toString().slice(8, 10) + " August";
        break;
    case "Sep":
        mounth.innerHTML =Date(weather.forecast.forecastday[0].astro.date).toString().slice(8, 10) +" September";
        break;
    case "Oct":
        mounth.innerHTML = Date(weather.forecast.forecastday[0].astro.date).toString().slice(8, 10) +" October";
        break;
    case "Nov":
        mounth.innerHTML = Date(weather.forecast.forecastday[0].astro.date).toString().slice(8, 10) +" November";
        break;
    case "Dec":
        mounth.innerHTML =Date(weather.forecast.forecastday[0].astro.date).toString().slice(8, 10) +" December";
        break;
    }
